...
const mockReports: Report[] = [
  {
    id: 'RPT-2024-001',
    title: 'MRT Tunnel Flooding Incident Report',
    type: 'incident',
    status: 'pending',
    author: 'Lim Wei Ming',
  ...
  {
    id: 'RPT-2024-003',
    title: 'Jurong Island Chemical Spill After-Action Review',
    type: 'after-action',
    status: 'draft',
    author: 'Ahmad Razali',
  ...
  },
  {
    ...
    type: 'daily',
    status: 'approved',
    author: 'SCDF Operations Centre',
    createdAt: '2024-01-15 06:00',
    updatedAt: '2024-01-15 06:00',
  },
  {
    id: 'RPT-2024-005',
    title: 'Safety Audit - Changi Fire Station',
    type: 'safety',
    status: 'pending',
    author: 'Priya Nair',
  ...
  {
    id: 'RPT-2024-006',
    title: 'PIE Multi-Vehicle Collision Analysis',
    type: 'incident',
    status: 'approved',
    author: 'David Koh',
  ...
  {
    id: 'RPT-2024-007',
    title: 'National Day Emergency Response Drill Report',
    type: 'after-action',
    status: 'archived',
    author: 'SCDF Training Division',
